...
const RESEARCH_DESCRIPTION =
  "Research investigates safety signals and gathers evidence. Research produces proposal drafts but does not change production knowledge.";
  ...
  return (
    <div className="flex flex-col gap-8">
      <header className="flex items-center justify-between pb-4 border-b border-[#E2E8F0]">
        <div>
          <h1 className="orch-section-header text-[22px]">Investigation Workspace</h1>
